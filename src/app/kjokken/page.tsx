...
const faq = [
  ...
  { question: "Er kjøkken et våtrom?", answer: "Nei, kjøkken regnes ikke som våtrom etter norske byggeregler. Det er derfor ikke krav til membran eller sluk. Men området rundt vask bør ha vannfast overflate, og det anbefales vanntett tilkobling under vasken." },
