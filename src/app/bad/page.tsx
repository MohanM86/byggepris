...
export const metadata: Metadata = { title: "Hva koster nytt bad? Pris for bad", description: "Pris for nytt bad 40 000-80 000 kr per m2. Se prisguide.", alternates: { canonical: "https://byggepris.no/bad" } };
export default function Page() {
  const project = projectTypes.find((p) => p.slug === "bad")!;
  return (<CategoryPageTemplate project={project}
    intro="Et nytt bad i Norge koster typisk mellom 40 000 og 80 000 kr per m2. For et standard bad på 6 m2 betyr det ca. 240 000-480 000 kroner."
    ...
    relatedSlugs={["kjokken","oppussing","totalrenovering","tilbygg"]}
    relatedNames={["Kjøkken","Oppussing","Totalrenovering","Tilbygg"]}
  />);
}
