...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Typisk pris 30 000-55 000 kr per m². Komplett prisguide for nybygg.",
...
export default function ByggeHus() {
  ...
  return (
    <>
      ...
      <ArticleSchema title="Hva koster det å bygge hus?" description="Komplett prisguide for husbygging i Norge. Typisk pris 30 000-55 000 kr per m²." slug="bygge-hus" />
      <FAQSchema items={faq} />
