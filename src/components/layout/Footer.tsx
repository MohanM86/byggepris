...
const footerLinks = [
  { title: "Byggeprosjekter", links: [{ href: "/bygge-hus", label: "Bygge hus" },{ href: "/tilbygg", label: "Tilbygg" },{ href: "/oppussing", label: "Oppussing" },{ href: "/totalrenovering", label: "Totalrenovering" },{ href: "/bad", label: "Bad" },{ href: "/kjokken", label: "Kjøkken" },{ href: "/garasje", label: "Garasje" },{ href: "/hytte", label: "Hytte" },{ href: "/terrasse", label: "Terrasse" },{ href: "/tak", label: "Tak" },{ href: "/fasade", label: "Fasade" },{ href: "/kjeller", label: "Kjeller" },{ href: "/flipping", label: "Flipping" },{ href: "/utleiedel", label: "Utleiedel" }] },
  { title: "Fagfolk og materialer", links: [{ href: "/elektriker", label: "Elektriker" },{ href: "/rorlegger", label: "Rørlegger" },{ href: "/maling", label: "Maling" },{ href: "/gulv", label: "Gulv" },{ href: "/vinduer", label: "Vinduer" },{ href: "/isolasjon", label: "Isolasjon" },{ href: "/varmepumpe", label: "Varmepumpe" },{ href: "/pipe-og-ildsted", label: "Pipe og ildsted" },{ href: "/grunnarbeid", label: "Grunnarbeid" },{ href: "/drenering", label: "Drenering" },{ href: "/byggesaknad", label: "Byggesøknad" }] },
  { title: "Prisguider", links: [{ href: "/byggepriser", label: "Byggepriser" },{ href: "/pris-per-kvm", label: "Pris per m²" },{ href: "/byggekostnader", label: "Byggekostnader" },{ href: "/hva-koster-det-a-bygge-hus", label: "Hva koster husbygging?" },{ href: "/hva-pavirker-byggekostnad", label: "Hva påvirker kostnad?" },{ href: "/skjulte-kostnader-ved-oppussing", label: "Skjulte kostnader" },{ href: "/bygge-nytt-vs-pusse-opp", label: "Bygge nytt vs pusse opp" },{ href: "/oppussing-for-salg", label: "Oppussing før salg" },{ href: "/kalkulator", label: "Byggekalkulator" }] },
